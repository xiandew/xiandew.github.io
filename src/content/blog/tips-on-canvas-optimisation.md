...
description: "Practical HTML5 canvas performance tips for games: reduce draw calls, use dirty rectangles/offscreen canvases, batch paths, avoid expensive state changes, and more."
pubDate: 2019-03-26
author: "Xiande Wen"
tags: ["canvas", "html5", "performance", "game-development", "optimization"]
---
...
calls can give it a obviously improved performance. When calling draw functions
...
- [ Optimising HTML5 Canvas games](https://nicolahibbert.com/optimising-html5-canvas-games/)
- [提高HTML5 canvas性能的几种方法！](https://my.oschina.net/aaronzh/blog/132346)